...
/// An implementation of [MethodChannelFlutterGoogleGeminiPlatform] that uses method channels.
class MethodChannelFlutterGoogleGeminiPlatform
    extends FlutterGoogleGeminiPlatformInterfacePlatform {
  /// The method channel used to interact with the native platform.
  static const _channel =
      MethodChannel("com.bensonarafat/flutter_google_gemini");
